...
if __name__ == "__main__":
    ...
    exp1 = experience.Experience(start_date, end_date, "ICICI", "BSM", )
    print(not isinstance(exp1,experience.Experience))

    start_date = datetime.datetime(2022, 1, 1)
    end_date = datetime.datetime(2022, 2, 2)
    exp2 = experience.Experience(start_date, end_date, "INFY", "Executive", False)

    start_date = datetime.datetime(2022, 3, 2)
    end_date = datetime.datetime(2022, 3, 2)
    exp3 = experience.Experience(start_date, end_date, "Spark Eighteen", "Intern", True)

    parag = person.Person("Parag")
